/* ============================================================
   letters.js — generates the daily mail.
   ============================================================ */

const Letters = {
  templates: [
    { from:'bunny', body:`Dear {playerName},\n\nDon't tell ANYONE I said this but I think Bramble has been leaving extra zucchini on Pip's doorstep again. They had ANOTHER fight at the market about the compost bin and now zucchini? I'm DYING. Please tell me what you know.\n\n— Bunny` },
    ...
    { from:'pip', body:`Hi Keeper!\n\nQuick note. Bramble keeps leaving me zucchini. I don't know how to make it stop. I would like to make it stop.\n\nIf you happen to see them, casually mention I am ALLERGIC. I am not. But please.\n\n— Pip ✿` },
    { from:'mayor', body:`RE: COVE ORDINANCE 4.7B (REVISED)\n\nDear Citizen,\n\nEffective immediately, lighthouse beams may no longer rotate counter-clockwise on Tuesdays. Failure to comply will result in a strongly-worded follow-up letter.\n\nSincerely,\nTHE MAYOR\n(Re-elect THE MAYOR)` },
    { from:'echo',  body:`I am told to tell you nothing.\n\nSo I have written nothing here.\n\nThe blank space below is on purpose.\n\n\n\n\n\n— E.` },
    { from:'wren',  body:`Echo says hello. (Echo did not say hello.) We don't agree on what to write. So we wrote nothing in particular.\n\n— W.` },
  ],
